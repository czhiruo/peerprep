...
const HintButton = () => {
    ...
    const handleGenerateHint = async () => {
        setIsLoading(true);
        document.getElementById('hint_modal').showModal();
    ...
    return(
        <div>
            <button className="btn" onClick={handleGenerateHint}>Show Hint</button>
            ...
            <div className="modal-box max-w-[45rem]">
                ...
                <p className="pt-3 text-gray-400 text-sm">Hint to solve the question</p>
                <p className="pb-3 text-gray-400 text-sm"><strong>Note:</strong> The hints provided below is generated using Vertex AI</p>
